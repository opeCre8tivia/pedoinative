...
data class Member(val first_name:String,val last_name:String, val email:String)

@Composable
fun RegisterScreen(authNavController:NavController){
    ...
    Surface(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            NormalText(value = "Pedoi Farmer registration")
            ...
            CustomButton(title = "Register") {
                authNavController.navigate(ScreenNames.FarmerNavigationScreen.name)
            }
